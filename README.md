...
- `index.html` is the whole app (data, styles and logic).
- `sw.js` caches the app shell and fonts. Bump `VERSION` when `index.html` changes.
- `manifest.json` and the `icon-*.png` files make it installable.
